...
Имена стилей, как и слои, а также иные служебные неграфические объекты подчиняются единым правилам (см. [статью](\Topic_CreateAndEditNcObjects_EditNamedAnd2D_Named_Rename.md)). Вы можете изменить существующий стиль, изменив свойства объекта `TextStyleTableRecord`, полученного для записи. Если вы хотите работать с активным стилем текста, получите его `TextStyleTableRecord`, воспользовавшись идентификатором (ObjectId) активного стиля по свойству TextStyle объекта Database. 
