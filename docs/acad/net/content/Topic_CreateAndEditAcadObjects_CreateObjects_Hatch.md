...
При вводе имени образца используйте имя, допустимое для файла:определения штриховки в соответствии с её типом, указанным выше. 
  ...
  | ----------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | ![](assets/2026-03-05-13-53-00-image.png) | Обычная (HatchStyle.Normal)               | Задает стандартный стиль -- значение по умолчанию для свойства HatchStyle. Этот параметр заштриховывает область "снаружи -- внутрь". Если AutoCAD встречает внутреннюю границу, он отключает штриховку до тех пор, пока не встретит другую границу |
