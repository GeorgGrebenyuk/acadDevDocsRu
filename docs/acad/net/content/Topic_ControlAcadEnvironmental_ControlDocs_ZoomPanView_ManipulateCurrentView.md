...
* Height : Высота вида в координатах DCS (см. [термины](./Topic_3D_ConvertCoords.md)); 
* Target : Целевая точка перспективной проекции для данного ВЭ; 
* ViewDirection : вектор от точки Target до камеры вида в координатах DCS (см. [термины](./Topic_3D_ConvertCoords.md)); 
* ViewTwist : угол поворота в радианах для вида; 
* Width : Ширина вида в координатах DCS (см. [термины](./Topic_3D_ConvertCoords.md)); 
