...
4. В контексте сборки объявите атрибут CommandClass для каждого класса, определяющего методы команд nanoCAD. 
