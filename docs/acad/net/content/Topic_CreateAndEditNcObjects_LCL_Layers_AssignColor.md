...
Если вы используете цвет ACI=0 или ByBlock, nanoCAD рисует новые объекты в цвете по умолчанию (белом или черном, в зависимости от настроек приложения), пока они не будут добавлены в блок. При размещении объекты в конкретном блоке (объекте таблицы записи блоков), объекты наследуют его текущие настройки свойств. 
